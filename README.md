...
wRPC operates under assumption that transport communication channels can be "indexed" by a sequence of unsized, unsigned 32-bit integers, which represent a reflective structural path.
