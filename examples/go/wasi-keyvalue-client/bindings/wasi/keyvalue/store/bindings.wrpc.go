...
func Open(ctx__ context.Context, wrpc__ wrpc.Invoker, identifier string) (r0__ *wrpc.Result[wrpc.Own[Bucket], Error], err__ error) {
	...
	r0__, err__ = func(r wrpc.IndexReader, path ...uint32) (*wrpc.Result[wrpc.Own[Bucket], Error], error) {
		...
		case 1:
			...
			v, err := func(r wrpc.IndexReader, path ...uint32) (*Error, error) {
				v := &Error{}
...
func Bucket_Get(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[Bucket], key string) (r0__ *wrpc.Result[[]uint8, Error], err__ error) {
	...
	r0__, err__ = func(r wrpc.IndexReader, path ...uint32) (*wrpc.Result[[]uint8, Error], error) {
		slog.Debug("reading result status byte")
		status, err := r.ReadByte()
		if err != nil {
			return nil, fmt.Errorf("failed to read result status byte: %w", err)
		...
		case 0:
			slog.Debug("reading `result::ok` payload")
			v, err := func(r wrpc.IndexReader, path ...uint32) ([]uint8, error) {
...
func Bucket_ListKeys(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[Bucket], cursor *uint64) (r0__ *wrpc.Result[KeyResponse, Error], err__ error) {
	...
	r0__, err__ = func(r wrpc.IndexReader, path ...uint32) (*wrpc.Result[KeyResponse, Error], error) {
		slog.Debug("reading result status byte")
		status, err := r.ReadByte()
		if err != nil {
			return nil, fmt.Errorf("failed to read result status byte: %w", err)
		...
		case 0:
			slog.Debug("reading `result::ok` payload")
			v, err := func(r wrpc.IndexReader, path ...uint32) (*KeyResponse, error) {
				v := &KeyResponse{}
				var err error
				slog.Debug("reading field", "name", "keys")
				v.Keys, err = func(r wrpc.IndexReader, path ...uint32) ([]string, error) {
					var x uint32
					var s uint
					for i := 0; i < 5; i++ {
				...
				v.Cursor, err = func(r wrpc.IndexReader, path ...uint32) (*uint64, error) {
					slog.Debug("reading option status byte")
					status, err := r.ReadByte()
					if err != nil {
						return nil, fmt.Errorf("failed to read option status byte: %w", err)
