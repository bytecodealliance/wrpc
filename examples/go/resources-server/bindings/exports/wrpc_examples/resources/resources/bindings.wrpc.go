			...
			for index, write := range writes {
				...
				go func() {
					if err := write(w); err != nil {
						slog.WarnContext(ctx, "failed to write nested result value", "index", index, "instance", "wrpc-examples:resources/resources", "name", "foo", "err", err)
					}
				}()
			}
		}
	...
	stop1, err := s.Serve("wrpc-examples:resources/resources", "foo.foo", func(ctx context.Context, w wrpc.IndexWriteCloser, r wrpc.IndexReadCloser) {
		...
		if len(writes) > 0 {
			for index, write := range writes {
				...
				go func() {
					if err := write(w); err != nil {
						slog.WarnContext(ctx, "failed to write nested result value", "index", index, "instance", "wrpc-examples:resources/resources", "name", "foo.foo", "err", err)
					}
				}()
			}
		}
	...
	stop2, err := s.Serve("wrpc-examples:resources/resources", "foo.bar", func(ctx context.Context, w wrpc.IndexWriteCloser, r wrpc.IndexReadCloser) {
		...
		if len(writes) > 0 {
			for index, write := range writes {
				...
				go func() {
					if err := write(w); err != nil {
						slog.WarnContext(ctx, "failed to write nested result value", "index", index, "instance", "wrpc-examples:resources/resources", "name", "foo.bar", "err", err)
					}
				}()
			}
		}
	...
	stop3, err := s.Serve("wrpc-examples:resources/resources", "bar", func(ctx context.Context, w wrpc.IndexWriteCloser, r wrpc.IndexReadCloser) {
		...
		if len(writes) > 0 {
			for index, write := range writes {
				...
				go func() {
					if err := write(w); err != nil {
						slog.WarnContext(ctx, "failed to write nested result value", "index", index, "instance", "wrpc-examples:resources/resources", "name", "bar", "err", err)
					}
				}()
			}
		}
