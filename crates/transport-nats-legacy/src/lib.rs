...
impl wrpc_transport_legacy::Subject for Subject {
...
impl wrpc_transport_legacy::Subscriber for Subscriber {
...
impl wrpc_transport_legacy::Transmitter for Transmitter {
    type Subject = Subject;
...
impl wrpc_transport_legacy::Invocation for Invocation {
...
impl wrpc_transport_legacy::Acceptor for Acceptor {
    type Subject = Subject;
